...
export class PaoIntegralPage {
  ...
  public receitasIni: string = 'Clique em editar e escreva a técnica de preparo do ' + this.pagina[5];
  public conteudoCard;
  public textoEdicao;
  ...
  public chaveReceita: string = 'Tecnica de preparo ' + this.pagina[5];
  ...
  calculosValoresIngredientes() {
    ...
    var aux1 = this.valorCompras.fareloTrigo * this.valorIngredientes.precoFareloTrigo / Number(this.valorIngredientes.fareloTrigo * 1000);
    this.totIngredientes[1] = aux1.toFixed(2);
    var aux2 = this.valorCompras.aveiaFlocosGrossos * this.valorIngredientes.precoAveiaFlocosGrossos / Number(this.valorIngredientes.aveiaFlocosGrossos * 1000);
    this.totIngredientes[2] = aux2.toFixed(2);
    var aux3 = this.valorCompras.farinhaTrigoIntegral * this.valorIngredientes.precoFarinhaTrigoIntegral / Number(this.valorIngredientes.farinhaTrigoIntegral * 1000);
    this.totIngredientes[3] = aux3.toFixed(2);
    var aux4 = this.valorCompras.acucar * this.valorIngredientes.precoAcucar / Number(this.valorIngredientes.acucar * 1000);
    this.totIngredientes[4] = aux4.toFixed(2);
    var aux5 = this.valorCompras.sal * this.valorIngredientes.precoSal / Number(this.valorIngredientes.sal * 1000);
    this.totIngredientes[5] = aux5.toFixed(2);
    var aux6 = this.valorCompras.fermentoBiologico * this.valorIngredientes.precoFermentoBiologico / this.valorIngredientes.fermentoBiologico * 1000;
