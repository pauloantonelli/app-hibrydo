...
@IonicPage()
@Component({
  selector: 'page-pao-beterraba',
  templateUrl: 'pao-beterraba.html'
})
export class PaoBeterrabaPage {
  public pagina = this.rota.pgNome;
  public titulo = this.rota.compraIngrediente;
  public imagem = this.rota.img;
  public receitasIni: string = 'Clique em editar e escreva a técnica de preparo do ' + this.pagina[1];
  public conteudoCard;
  public textoEdicao;
  ...
  public chaveReceita: string = 'Tecnica de preparo ' + this.pagina[1];
  ...
  calculosValoresIngredientes(){
    ...
    var aux3 = this.valorCompras.beterraba * this.valorIngredientes.precoBeterraba / Number(this.valorIngredientes.beterraba * 1000);
