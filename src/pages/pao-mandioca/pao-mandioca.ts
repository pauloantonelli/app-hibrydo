...
export class PaoMandiocaPage {
  ...
  public receitasIni: string = 'Clique em editar e escreva a técnica de preparo do ' + this.pagina[9];
  public conteudoCard;
  public textoEdicao;
  ...
  public chaveReceita: string = 'Tecnica de preparo ' + this.pagina[9];
  ...
  consultaCompras(chave: string){
    ...
    calculosValoresIngredientes(){
      ...
      var aux4 = this.valorCompras.azeitonaVerde * this.valorIngredientes.precoAzeitonaVerde /this.valorIngredientes.azeitonaVerde;
      this.totIngredientes[4] = aux4.toFixed(2);
      var aux5 = this.valorCompras.mandioca * this.valorIngredientes.precoMandioca / Number(this.valorIngredientes.precoMandioca * 1000);
