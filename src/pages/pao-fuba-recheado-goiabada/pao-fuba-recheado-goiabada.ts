...
export class PaoFubaRecheadoGoiabadaPage {
  ...
  calculosValoresIngredientes() {
    ...
    var aux3 = this.valorCompras.fuba * this.valorIngredientes.precoFuba / Number(this.valorIngredientes.fuba * 1000);
    this.totIngredientes[3] = aux3.toFixed(2);
    var aux4 = this.valorCompras.ervaDoce * this.valorIngredientes.precoErvaDoce / this.valorIngredientes.ervaDoce;
    this.totIngredientes[4] = aux4.toFixed(2);
    var aux5 = this.valorCompras.fermentoBiologico * this.valorIngredientes.precoFermentoBiologico / this.valorIngredientes.fermentoBiologico;
    this.totIngredientes[5] = aux5.toFixed(2);
    var aux6 = this.valorCompras.goiabada * this.valorIngredientes.precoGoiabada / Number(this.valorIngredientes.goiabada * 1000);
