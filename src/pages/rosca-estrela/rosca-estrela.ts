...
export class RoscaEstrelaPage {
  ...
  public receitasIni: string = 'Clique em editar e escreva a técnica de preparo do ' + this.pagina[10];
  public conteudoCard;
  public textoEdicao;
  ...
  public chaveReceita: string = 'Tecnica de preparo ' + this.pagina[10];
  ...
  consultaCompras(chave: string){
    ...
    calculosValoresIngredientes(){
      ...
      var aux3 = this.valorCompras.fermentoBiologico * this.valorIngredientes.precoFermentoBiologico / this.valorIngredientes.fermentoBiologico;
      this.totIngredientes[3] = aux3.toFixed(2);
      var aux4 = this.valorCompras.margarina * this.valorIngredientes.precoMargarina / this.valorIngredientes.margarina;
      this.totIngredientes[4] = aux4.toFixed(2);
      var aux5 = this.valorCompras.cocoRalado * this.valorIngredientes.precoCocoRalado / this.valorIngredientes.cocoRalado;
      ...
      var aux7 = this.valorCompras.leite * this.valorIngredientes.precoLeite / Number(this.valorIngredientes.leite * 1000);
      this.totIngredientes[7] = aux7.toFixed(2);
      var aux8 = this.valorCompras.leiteCoco * this.valorIngredientes.precoLeiteCoco / this.valorIngredientes.leiteCoco;
      this.totIngredientes[8] = aux8.toFixed(2);
      var aux9 = this.valorCompras.ovo * this.valorIngredientes.precoOvo /this.valorIngredientes.ovo;
      this.totIngredientes[9] = aux9.toFixed(2);
      var aux10 = this.valorCompras.embalagem * this.valorIngredientes.precoEmbalagem /this.valorIngredientes.embalagem;
      this.totIngredientes[10] = aux10.toFixed(2);
      
      //CALCULA O VALOR R$ TOTAL USADO NA RECEITA
      var aux = aux0 + aux1 + aux2 + aux3 + aux4 + aux5 + aux6 + aux7 + aux8 + aux9 + aux10;
