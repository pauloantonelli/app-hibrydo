...
export class PaoFormaTradicionalPage {
  ...
  public receitasIni: string = 'Clique em editar e escreva a técnica de preparo do ' + this.pagina[3];
  public conteudoCard;
  public textoEdicao;
  ...
  public chaveReceita: string = 'Tecnica de preparo ' + this.pagina[3];
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public conexao: ConexaoProvider, public compraProvider: ComprasProvider, public receitaProvider: ReceitasProvider, public toast: ToastController, public rota: RotasProvider) {
    ...
    this.chave = 'Pao de Forma Tradicional';
  ...
  calculosValoresIngredientes(){
    ...
    var aux4 = this.valorCompras.oleo * this.valorIngredientes.precoOleo / Number(this.valorIngredientes.oleo * 1000);
    this.totIngredientes[4] = aux4.toFixed(2);
    var aux5 = this.valorCompras.leite * this.valorIngredientes.precoLeite / Number(this.valorIngredientes.leite * 1000);
    this.totIngredientes[5] = aux5.toFixed(2);
    var aux6 = this.valorCompras.ovo * this.valorIngredientes.precoOvo / this.valorIngredientes.ovo;
    this.totIngredientes[6] = aux6.toFixed(2);
    var aux7 = this.valorCompras.embalagem * this.valorIngredientes.precoEmbalagem /this.valorIngredientes.embalagem;
    this.totIngredientes[7] = aux7.toFixed(2);
    
    //CALCULA O VALOR R$ TOTAL USADO NA RECEITA
    var aux = aux0 + aux1 + aux2 + aux3 + aux4 + aux5 + aux6 + aux7;
